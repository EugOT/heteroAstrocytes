...
sc.tl.rank_genes_groups(
    adata_eval2,
    groupby="predict_xgboost_subregion",
    method="logreg",
    n_genes=adata_eval2.raw.shape[1]
)
```
...
sc.pl.rank_genes_groups_dotplot(
    ...
    use_raw=False,
    show=True,
    save="-DGE_4-scores" + save_PRJNA779749,
)
```
...
sc.pl.rank_genes_groups_dotplot(
    ...
    use_raw=False,
    show=True,
    save="-DGE_15-scores" + save_PRJNA779749,
)
```
...
sc.pl.rank_genes_groups_dotplot(
    ...
    show=True,
    save="-DGE_15-logfoldchanges" + save_PRJNA779749,
)
```
...
sc.tl.filter_rank_genes_groups(
    ...
    use_raw=False,
    min_in_group_fraction=0.85,
    max_out_group_fraction=0.45,
    min_fold_change=2
)
```
...
sc.pl.rank_genes_groups_dotplot(
    ...
    use_raw=False,
    show=True,
    save="-filtered-DGE_4-scores" + save_PRJNA779749,
)
```
...
sc.pl.rank_genes_groups_dotplot(
    ...
    use_raw=False,
    show=True,
    save="-filtered-DGE_15-scores" + save_PRJNA779749,
)
```
...
sc.pl.rank_genes_groups_dotplot(
    ...
    colorbar_title='log fold change'
    show=True,
    save="-filtered-DGE_15-logfoldchanges" + save_PRJNA779749,
)
```
...
```{python}
sc.tl.rank_genes_groups(
    PRJNA779749_regulons,
    groupby="predict_xgboost_subregion",
    method="logreg",
    n_genes=PRJNA779749_regulons.raw.shape[1]
)
```
...
sc.pl.rank_genes_groups_dotplot(
    ...
    use_raw=False,
    show=True,
    save="-regulons_4-scores" + save_PRJNA779749,
)
```
...
sc.pl.rank_genes_groups_dotplot(
    ...
    use_raw=False,
    show=True,
    save="-regulons_15-scores" + save_PRJNA779749,
)
```
...
sc.pl.rank_genes_groups_dotplot(
    ...
    colorbar_title='log fold change'
    show=True,
    save="-regulons_15-logfoldchanges" + save_PRJNA779749,
)
```
...
sc.pl.rank_genes_groups_dotplot(
    ...
    use_raw=False,
    show=True,
    save="-filtered-regulons_4-scores" + save_PRJNA779749,
)
```
...
sc.pl.rank_genes_groups_dotplot(
    ...
    use_raw=False,
    show=True,
    save="-filtered-regulons_15-scores" + save_PRJNA779749,
)
```
...
sc.pl.rank_genes_groups_dotplot(
    ...
    colorbar_title='log fold change'
    show=True,
    save="-filtered-regulons_15-logfoldchanges" + save_PRJNA779749,
)
```
...
```{python}
sc.tl.rank_genes_groups(
    PRJNA548917_regulons,
    groupby="predict_xgboost_subregion",
    method="logreg",
    n_genes=PRJNA548917_regulons.raw.shape[1]
)
```
...
sc.pl.rank_genes_groups_dotplot(
    ...
    use_raw=False,
    show=True,
    save="-regulons_4-scores" + save_PRJNA548917,
)
```
...
sc.pl.rank_genes_groups_dotplot(
    ...
    use_raw=False,
    show=True,
    save="-regulons_15-scores" + save_PRJNA548917,
)
```
...
sc.pl.rank_genes_groups_dotplot(
    ...
    colorbar_title='log fold change'
    show=True,
    save="-regulons_15-logfoldchanges" + save_PRJNA548917,
)
```
...
sc.pl.rank_genes_groups_dotplot(
    ...
    use_raw=False,
    show=True,
    save="-filtered-regulons_4-scores" + save_PRJNA548917,
)
```
...
sc.pl.rank_genes_groups_dotplot(
    ...
    use_raw=False,
    show=True,
    save="-filtered-regulons_15-scores" + save_PRJNA548917,
)
```
...
sc.pl.rank_genes_groups_dotplot(
    ...
    colorbar_title='log fold change'
    show=True,
    save="-filtered-regulons_15-logfoldchanges" + save_PRJNA548917,
)
```
...
```{python}
sc.tl.rank_genes_groups(
    PRJNA547712_regulons,
    groupby="predict_xgboost_subregion",
    method="logreg",
    n_genes=PRJNA547712_regulons.raw.shape[1]
)
```
...
sc.pl.rank_genes_groups_dotplot(
    ...
    use_raw=False,
    show=True,
    save="-regulons_4-scores" + save_PRJNA547712,
)
```
...
sc.pl.rank_genes_groups_dotplot(
    ...
    use_raw=False,
    show=True,
    save="-regulons_15-scores" + save_PRJNA547712,
)
```
...
sc.pl.rank_genes_groups_dotplot(
    ...
    colorbar_title='log fold change'
    show=True,
    save="-regulons_15-logfoldchanges" + save_PRJNA547712,
)
```
...
sc.pl.rank_genes_groups_dotplot(
    ...
    use_raw=False,
    show=True,
    save="-filtered-regulons_4-scores" + save_PRJNA547712,
)
```
...
sc.pl.rank_genes_groups_dotplot(
    ...
    use_raw=False,
    show=True,
    save="-filtered-regulons_15-scores" + save_PRJNA547712,
)
```
...
sc.pl.rank_genes_groups_dotplot(
    ...
    colorbar_title='log fold change'
    show=True,
    save="-filtered-regulons_15-logfoldchanges" + save_PRJNA547712,
)
```
...
```{python}
sc.tl.rank_genes_groups(
    PRJNA438862_regulons,
    groupby="predict_xgboost_subregion",
    method="logreg",
    n_genes=PRJNA438862_regulons.raw.shape[1]
)
```
...
sc.pl.rank_genes_groups_dotplot(
    ...
    use_raw=False,
    show=True,
    save="-regulons_4-scores" + save_PRJNA438862,
)
```
...
sc.pl.rank_genes_groups_dotplot(
    ...
    use_raw=False,
    show=True,
    save="-regulons_15-scores" + save_PRJNA438862,
)
```
...
sc.pl.rank_genes_groups_dotplot(
    ...
    colorbar_title='log fold change'
    show=True,
    save="-regulons_15-logfoldchanges" + save_PRJNA438862,
)
```
...
sc.pl.rank_genes_groups_dotplot(
    ...
    use_raw=False,
    show=True,
    save="-filtered-regulons_4-scores" + save_PRJNA438862,
)
```
...
sc.pl.rank_genes_groups_dotplot(
    ...
    use_raw=False,
    show=True,
    save="-filtered-regulons_15-scores" + save_PRJNA438862,
)
```
...
sc.pl.rank_genes_groups_dotplot(
    ...
    colorbar_title='log fold change'
    show=True,
    save="-filtered-regulons_15-logfoldchanges" + save_PRJNA438862,
)
```
