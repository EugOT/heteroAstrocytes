---
title: "Detailed CellChat signalling analysis of Lxn positive vs. Lxn negative astrocytes"
...
DOCNAME <- "cellchatdb-signalling-between-agrp-or-pomc-neurons-and-lxn-pos-or-neg-astrocytes-in-arc-and-pvn"
NOW <- Sys.time()
...
```{r deng2020-signalling-to-pomc-neurons}
...
```{r deng2020-plot-receptors-complexes-signalling-to-pomc-neurons}
# Generate the plot
...
```{r deng2020-plot-ligands-complexes-signalling-to-pomc-neurons}
...
```{r deng2020-plot-ligand-receptor-complexes-signalling-to-pomc-neurons}
...
```{r hfd-deng2020-signalling-to-pomc-neurons}
df <- df_complex_conditions %>%
  filter(
    pairs %in% c(
      "Astro_LXN+==>POMC neurons",
...
```{r hfd-deng2020-plot-receptors-complexes-signalling-to-pomc-neurons}
# Generate the plot
pr <- ggplot(df_long, aes(x = pairs, y = lr_probs, color = as.factor(diff_category), size = neg_log10_specificity_rank)) +
  geom_jitter(width = 0.05) +
  geom_line(aes(group = lr_complex), linetype = "solid", alpha = 0.2) +
...
```{r hfd-deng2020-plot-ligands-complexes-signalling-to-pomc-neurons}
pl <- ggplot(df_long, aes(x = pairs, y = lr_probs, color = as.factor(diff_category), size = neg_log10_specificity_rank)) +
  geom_jitter(width = 0.05) +
  geom_line(aes(group = lr_complex), linetype = "solid", alpha = 0.2) +
  theme_minimal() +
...
```{r hfd-deng2020-plot-ligand-receptor-complexes-signalling-to-pomc-neurons}
plr <- ggplot(df_long, aes(x = pairs, y = lr_probs, color = as.factor(diff_category), size = neg_log10_specificity_rank)) +
  geom_jitter(width = 0.05) +
  geom_line(aes(group = lr_complex), linetype = "solid", alpha = 0.2) +
  theme_minimal() +
...
```{r deng2020-signalling-to-agrp-neurons}
df <- df_complex_conditions %>%
  filter(
    pairs %in% c(
      "Astro_LXN+==>AGRP/NPY neurons",
...
```{r deng2020-plot-receptors-complexes-signalling-to-agrp-neurons}
# Generate the plot
pr <- ggplot(df_long, aes(x = pairs, y = lr_probs, color = as.factor(diff_category), size = neg_log10_specificity_rank)) +
  geom_jitter(width = 0.05) +
  geom_line(aes(group = lr_complex), linetype = "solid", alpha = 0.2) +
...
```{r deng2020-plot-ligands-complexes-signalling-to-agrp-neurons}
pl <- ggplot(df_long, aes(x = pairs, y = lr_probs, color = as.factor(diff_category), size = neg_log10_specificity_rank)) +
  geom_jitter(width = 0.05) +
  geom_line(aes(group = lr_complex), linetype = "solid", alpha = 0.2) +
  theme_minimal() +
...
```{r deng2020-plot-ligand-receptor-complexes-signalling-to-agrp-neurons}
plr <- ggplot(df_long, aes(x = pairs, y = lr_probs, color = as.factor(diff_category), size = neg_log10_specificity_rank)) +
  geom_jitter(width = 0.05) +
  geom_line(aes(group = lr_complex), linetype = "solid", alpha = 0.2) +
  theme_minimal() +
...
```{r hfd-deng2020-signalling-to-agrp-neurons}
df <- df_complex_conditions %>%
  filter(
    pairs %in% c(
      "Astro_LXN+==>AGRP/NPY neurons",
...
```{r hfd-deng2020-plot-receptors-complexes-signalling-to-agrp-neurons}
# Generate the plot
pr <- ggplot(df_long, aes(x = pairs, y = lr_probs, color = as.factor(diff_category), size = neg_log10_specificity_rank)) +
  geom_jitter(width = 0.05) +
  geom_line(aes(group = lr_complex), linetype = "solid", alpha = 0.2) +
...
```{r hfd-deng2020-plot-ligands-complexes-signalling-to-agrp-neurons}
pl <- ggplot(df_long, aes(x = pairs, y = lr_probs, color = as.factor(diff_category), size = neg_log10_specificity_rank)) +
  geom_jitter(width = 0.05) +
  geom_line(aes(group = lr_complex), linetype = "solid", alpha = 0.2) +
  theme_minimal() +
...
```{r hfd-deng2020-plot-ligand-receptor-complexes-signalling-to-agrp-neurons}
plr <- ggplot(df_long, aes(x = pairs, y = lr_probs, color = as.factor(diff_category), size = neg_log10_specificity_rank)) +
  geom_jitter(width = 0.05) +
  geom_line(aes(group = lr_complex), linetype = "solid", alpha = 0.2) +
  theme_minimal() +
...
```{r lutomska2022-signalling-to-pomc-neurons}
df <- df_complex_conditions %>%
  filter(
    pairs %in% c(
      "Astro_LXN+==>POMC neurons",
...
```{r lutomska2022-plot-receptors-complexes-signalling-to-pomc-neurons}
# Generate the plot
pr <- ggplot(df_long, aes(x = pairs, y = lr_probs, color = as.factor(diff_category), size = neg_log10_specificity_rank)) +
  geom_jitter(width = 0.05) +
  geom_line(aes(group = lr_complex), linetype = "solid", alpha = 0.2) +
...
```{r lutomska2022-plot-ligands-complexes-signalling-to-pomc-neurons}
pl <- ggplot(df_long, aes(x = pairs, y = lr_probs, color = as.factor(diff_category), size = neg_log10_specificity_rank)) +
  geom_jitter(width = 0.05) +
  geom_line(aes(group = lr_complex), linetype = "solid", alpha = 0.2) +
  theme_minimal() +
...
```{r lutomska2022-plot-ligand-receptor-complexes-signalling-to-pomc-neurons}
plr <- ggplot(df_long, aes(x = pairs, y = lr_probs, color = as.factor(diff_category), size = neg_log10_specificity_rank)) +
  geom_jitter(width = 0.05) +
  geom_line(aes(group = lr_complex), linetype = "solid", alpha = 0.2) +
  theme_minimal() +
...
```{r hfhsd-lutomska2022-signalling-to-pomc-neurons}
df <- df_complex_conditions %>%
  filter(
    pairs %in% c(
      "Astro_LXN+==>POMC neurons",
...
```{r hfhsd-lutomska2022-plot-receptors-complexes-signalling-to-pomc-neurons}
# Generate the plot
pr <- ggplot(df_long, aes(x = pairs, y = lr_probs, color = as.factor(diff_category), size = neg_log10_specificity_rank)) +
  geom_jitter(width = 0.05) +
  geom_line(aes(group = lr_complex), linetype = "solid", alpha = 0.2) +
...
```{r hfhsd-lutomska2022-plot-ligands-complexes-signalling-to-pomc-neurons}
pl <- ggplot(df_long, aes(x = pairs, y = lr_probs, color = as.factor(diff_category), size = neg_log10_specificity_rank)) +
  geom_jitter(width = 0.05) +
  geom_line(aes(group = lr_complex), linetype = "solid", alpha = 0.2) +
  theme_minimal() +
...
```{r hfhsd-lutomska2022-plot-ligand-receptor-complexes-signalling-to-pomc-neurons}
plr <- ggplot(df_long, aes(x = pairs, y = lr_probs, color = as.factor(diff_category), size = neg_log10_specificity_rank)) +
  geom_jitter(width = 0.05) +
  geom_line(aes(group = lr_complex), linetype = "solid", alpha = 0.2) +
  theme_minimal() +
...
```{r lutomska2022-signalling-to-agrp-neurons}
df <- df_complex_conditions %>%
  filter(
    pairs %in% c(
      "Astro_LXN+==>AGRP/NPY neurons",
...
```{r lutomska2022-plot-receptors-complexes-signalling-to-agrp-neurons}
# Generate the plot
pr <- ggplot(df_long, aes(x = pairs, y = lr_probs, color = as.factor(diff_category), size = neg_log10_specificity_rank)) +
  geom_jitter(width = 0.05) +
  geom_line(aes(group = lr_complex), linetype = "solid", alpha = 0.2) +
...
```{r lutomska2022-plot-ligands-complexes-signalling-to-agrp-neurons}
pl <- ggplot(df_long, aes(x = pairs, y = lr_probs, color = as.factor(diff_category), size = neg_log10_specificity_rank)) +
  geom_jitter(width = 0.05) +
  geom_line(aes(group = lr_complex), linetype = "solid", alpha = 0.2) +
  theme_minimal() +
...
```{r lutomska2022-plot-ligand-receptor-complexes-signalling-to-agrp-neurons}
plr <- ggplot(df_long, aes(x = pairs, y = lr_probs, color = as.factor(diff_category), size = neg_log10_specificity_rank)) +
  geom_jitter(width = 0.05) +
  geom_line(aes(group = lr_complex), linetype = "solid", alpha = 0.2) +
  theme_minimal() +
...
```{r hfhsd-lutomska2022-signalling-to-agrp-neurons}
df <- df_complex_conditions %>%
  filter(
    pairs %in% c(
      "Astro_LXN+==>AGRP/NPY neurons",
...
```{r hfhsd-lutomska2022-plot-receptors-complexes-signalling-to-agrp-neurons}
# Generate the plot
pr <- ggplot(df_long, aes(x = pairs, y = lr_probs, color = as.factor(diff_category), size = neg_log10_specificity_rank)) +
  geom_jitter(width = 0.05) +
  geom_line(aes(group = lr_complex), linetype = "solid", alpha = 0.2) +
...
```{r hfhsd-lutomska2022-plot-ligands-complexes-signalling-to-agrp-neurons}
pl <- ggplot(df_long, aes(x = pairs, y = lr_probs, color = as.factor(diff_category), size = neg_log10_specificity_rank)) +
  geom_jitter(width = 0.05) +
  geom_line(aes(group = lr_complex), linetype = "solid", alpha = 0.2) +
  theme_minimal() +
...
```{r hfhsd-lutomska2022-plot-ligand-receptor-complexes-signalling-to-agrp-neurons}
plr <- ggplot(df_long, aes(x = pairs, y = lr_probs, color = as.factor(diff_category), size = neg_log10_specificity_rank)) +
  geom_jitter(width = 0.05) +
  geom_line(aes(group = lr_complex), linetype = "solid", alpha = 0.2) +
  theme_minimal() +
...
```{r arc-vs-pvn-signalling-to-pomc-neurons}
df <- df_complex_conditions %>%
  filter(
    pairs == "Astro_LXN+==>POMC neurons",
...
```{r arc-vs-pvn-plot-receptors-complexes-signalling-to-pomc-neurons}
# Generate the plot
...
```{r arc-vs-pvn-plot-ligands-complexes-signalling-to-pomc-neurons}
...
```{r arc-vs-pvn-plot-ligand-receptor-complexes-signalling-to-pomc-neurons}
