---
title: "Functional heterogeneity of hypothalamic astrocytes"
...
plEmbCombBatch <- DimPlot(combined_sct,
  reduction = "umap",
  group.by = "Batch_ID",
  label = TRUE, repel = TRUE
) + NoLegend()
plEmbCombReg <- DimPlot(combined_sct,
  reduction = "umap",
...
pp + ggrepel::geom_label_repel(
  data = label_df, aes(x = x, y = y, label = label), colour = "black",
