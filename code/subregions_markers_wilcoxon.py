...
PLOTS_DIR = os.path.dirname(snakemake.output["top25_figures_wilcoxon"])
reseed = 42
random.seed(reseed)
...
save_plot = f"-wilcoxon-{subregions}-astrocytes_datasets-msp_{connectivity_model}-metric_{metric}-k_{k}-sign_{signature}-amb_{cb_fpr}.pdf"
